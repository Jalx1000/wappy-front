...
const paths: Record<string, React.ReactNode> = {
  ...
  fileText:   <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M8 13h8"/><path d="M8 17h5"/><path d="M8 9h1"/></>,
  ...
  products:   <><path d="M21 8 12 3 3 8l9 5 9-5z"/><path d="M3 8v8l9 5 9-5V8"/><path d="M12 13v8"/><path d="m7.5 10.5 9-5"/></>,
  ...
  calendarDays:<><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/><path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01M16 18h.01"/></>,
  ...
  car:         <><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18.4 5.5c-.4-.9-1.3-1.5-2.3-1.5H7.9c-1 0-1.9.6-2.3 1.5L3.5 11.1C2.7 11.3 2 12.1 2 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/></>,
  ...
  whatsapp:    <><path d="M3 21l1.9-5.6A8.38 8.38 0 1 1 12 20a8.5 8.5 0 0 1-4.3-1.2z"/><path d="M9 9c0 3 3 6 6 6l1.4-1.4-2-1-1 .8c-1-.5-1.8-1.3-2.3-2.3l.8-1-1-2z"/></>,
  sort:        <><line x1="4" y1="6" x2="20" y2="6"/><line x1="4" y1="12" x2="14" y2="12"/><line x1="4" y1="18" x2="9" y2="18"/></>,
  cursor:      <><path d="M3 3l7.07 16.97 2.51-7.39 7.39-2.51z"/><path d="m13 13 6 6"/></>,
};
